...
def read_args():
	...
	parser.add_argument("--expand_nt", help = "Use a 6-nucleotide version", default = False, action='store_true')
	...
	parser.add_argument("--aggressive", help = "Aggressive correction of errors using consensus in file building", default = None, type = int)
